...
class Base {
	...
	*/
	...
	public Base(HazelcastInstance client){
		/** TODO: NOTE: this complicates lock ownership, all our clients are the lock owners since we are a proxy, 
			imho, practically this doesnt change anything, revisit after pub/sub/topic...
		**/
		this.client = client;
	}
